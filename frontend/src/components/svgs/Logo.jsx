const LogoSvg = (props) => {
    return (
        <svg aria-hidden='true' viewBox='0 0 24 24' {...props}><g id="SVGRepo_bgCarrier" stroke-width="0" {...props}></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
